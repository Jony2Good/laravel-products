                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <form action="{{ route('admin.update', $item->id) }}" method="post">
                            @csrf
                            @method('PATCH')
                            <input type="hidden" value="{{$item->article}}" name="article">
                            @can('edit_article')
                            <div class="form-group mb-3 col-8">
                                <label class="text-secondary" for="article">{{__('Артикул')}}</label>
                            ...
                            @endcan
                            <div class="form-group mb-3 col-8">
                                <label class="text-secondary" for="product-name">{{__('Наименование')}}</label>
                            ...
                            <div class="form-group mb-3 col-8" data-select2-id="29">
                                <label class="text-secondary" for="status">{{__('Статус')}}</label>
                            ...
                            <div class="form-group mb-5 col-8">
                                ...
                                <div class="row mb-3">
                                    <div class="col-5">
                                        <label for="size" class="text-secondary" for="size">{{__('Размер')}}</label>
                                    ...
                                    <div class="col-5">
                                        <label for=color" class="text-secondary" for="color">{{__('Цвет')}}</label>
                                    ...
                                    <div class="col-1 d-flex justify-content-center align-items-end">
                                        <button class="btn border-0 text-secondary" disabled><i class="fa fa-trash"></i></button>
                                    </div>
                                </div>
